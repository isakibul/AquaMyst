        ...
        >
            ...
            <div className="flex flex-col items-center justify-center h-full space-y-4">
                <div className="w-[850px] h-[260px] bg-white shadow-lg flex justify-center items-center text-center rounded-3xl mb-6">
                    ...
                    >
                        <p className="font-anton text-gray-800 text-[48px] font-bold">LEVEL <span className='text-[56px]'>1</span></p>
                        <p
                            className="font-anton text-[80px] font-extrabold text-blue-600 gradient-text"
                        >
                            <span className='text-[90px]'>L</span>IGHTS OF THE <span className='text-[90px]'>D</span>EEP
                        </p>
                    </div>
